...
<h3>To install the required Prerequisites scroll down or follow the guide in this section  <a href="https://github.com/mchajdecki/Network-Activities---Prerequisites">Network Activities Prerequisites</h3>
